...
abstract class Dimens {
  ...
  static double twoSeventyFive = 275.sp;
  static double twoFiftySeven = 257.sp;
  ...
  static double oneSeventyFour = 174.sp;
  ...
  static double threeNineteen = 319.sp;
  static double fourHundredFifteen = 415.sp;
  static double fourHundredEighty = 480.sp;
  ...
  static EdgeInsets edgeInsets35 = EdgeInsets.fromLTRB(
    thirtyFive,
    thirtyFive,
    thirtyFive,
    thirtyFive,
  ...
  static EdgeInsets edgeInsets30_4_30_4 = EdgeInsets.fromLTRB(
    thirty,
    four,
    thirty,
    four,
  ...
  static EdgeInsets edgeInsets50_250_50_250 = EdgeInsets.fromLTRB(
    fifty,
  ...
  static EdgeInsets edgeInsets5_5_5_0 = EdgeInsets.fromLTRB(
    five,
    five,
    five,
    zero,
  ...
  static EdgeInsets edgeInsets5_0_10_0 = EdgeInsets.fromLTRB(
    five,
    zero,
    ten,
    zero,
  );
  static EdgeInsets edgeInsets8_0_5_0 = EdgeInsets.fromLTRB(
    eight,
    zero,
    five,
    zero,
  ...
  static EdgeInsets edgeInsets0_18_0_18 = EdgeInsets.fromLTRB(
    zero,
    eighteen,
    zero,
    eighteen,
  );
  static EdgeInsets edgeInsets18_18_0_18 = EdgeInsets.fromLTRB(
    eighteen,
    eighteen,
    zero,
    eighteen,
  );
  static EdgeInsets edgeInsets15_18_0_18 = EdgeInsets.fromLTRB(
    fifteen,
    eighteen,
    zero,
    eighteen,
  ...
  static SizedBox boxWidth70 = SizedBox(
    width: seventy,
  );
